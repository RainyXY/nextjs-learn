			...
			<div className='w-1/2'>
				...
				<div className='flex flex-col items-center justify-center mt-4 shadow-lg border border-gray-300 h-32 rounded-lg'>
					...
					<div className='flex flex-row items-center justify-between w-full h-12 mb-2'>
						<div>
							<div
								className={`flex flex-row items-center justify-center rounded-lg border px-2 py-1 ml-2 cursor-pointer ${model === 'deepseek-r1' ? 'border-blue-300 bg-blue-200' : 'border-gray-300'} `}
